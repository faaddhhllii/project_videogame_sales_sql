...
## Objective
This project aims to analyze video game sales trends based on various factors such as genre, region, publisher, developer, critic score, and release time. Using SQL, this analysis reveals the best-selling games and genres, regions with the highest sales, publisher and developer performance, and the relationship between critic scores and total sales. The results can provide insight for the gaming industry in determining more effective marketing and game development strategies.

## Dataset
The data for this project is sourced from the Kaggle dataset:

- **Dataset Link:** [Gamesales Dataset](https://www.kaggle.com/datasets/asaniczka/video-game-sales-2024)
